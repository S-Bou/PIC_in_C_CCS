...
#define RS232_XMIT     PIN_A4
#define RS232_RCV      PIN_A9
#define CAPTURE_PIN    PIN_E14
#define CAPTURE_TIMER  3
 
#pin_select U1TX=RS232_XMIT
#pin_select U1RX=RS232_RCV
#pin_select IC1=CAPTURE_PIN
 
#ifdef GENERATE_PWM_SIGNAL
 #define PWM_PIN       PIN_F1
 #define PWM_TIMER     2
    
 #pin_select OC1=PWM_PIN
#endif
