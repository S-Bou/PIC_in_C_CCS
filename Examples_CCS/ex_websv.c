...
//// must use the RAW protocol since s7600 isn't compatible with the ////
//// telnet protocol.                                                ////
////                                                                 ////
...
//#use rs232(baud=9600, xmit=PIN_C6, rcv=PIN_C7, errors) //Text through the UART
