...
////                         EX_CAN_CCS_A.C                          ////
////                                                                 ////
//// Example of CCS's CAN libraries, using the PIC18F45K80. This     ////
//// example was tested with and written for the CCS CAN Bus         ////
//// prototype board.                                                ////
////                                                                 ////
//// The CCS CAN Bus prototype board has four CAN nodes that         ////
//// communicate with each other.  Node A has a PIC18F45K80 on it    ////
//// with an ECAN peripheral to connect to the CAN Bus, Node B has   ////
//// PIC16F1936 using an MCP2515 CAN controller to connect to the    ////
//// CAN Bus, and Node C and Node D both have MCP250xx stand-alone   ////
//// CAN I/O expanders to connect to the CAN Bus.  This example is   ////
//// the firmware for Node A.                                        ////
////                                                                 ////
